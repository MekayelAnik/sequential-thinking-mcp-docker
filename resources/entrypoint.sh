...
readonly HAPROXY_SERVER_NAME="sequential-thinking"
...
start_mcp_server() {
    local mcp_server_cmd="npx -y @modelcontextprotocol/server-sequential-thinking"
    ...
    echo "Launching Sequential Thinking MCP with protocol: ${PROTOCOL_DISPLAY}"
